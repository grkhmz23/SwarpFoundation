...
type BellNotifyProps = {
  ...
  onButtonClick?: () => void;
  /** Link href for CTA button (if provided, navigates instead of onButtonClick). */
  buttonHref?: string;
...
function BellNotify({
  ...
  showButton = true,
  buttonLabel = 'Got idea? Check our services',
  onButtonClick,
  buttonHref = '/services',
  disableToggle = false,
  className = '',
  ...
  }, [onButtonClick, buttonHref, router]);
      ...
      <style jsx global>{`
        ...
        .bell-top {
          ...
          box-shadow: inset -1em -0.5em 2em 0.5em #fff,
            inset 1em -1em 2em 3em #000, 0 -0.1em 0.4em 0.3em #00fff0a8;
        }
        ...
        .bell-base {
          ...
          translate: 0 -24%;
          background: var(--base-clr);
          box-shadow: 0 -0.1em 0.4em 0.2em #00fff0a8;
        }
        .bell-base:before {
          content: '';
        ...
        .bell-buff {
          ...
          translate: 0 20em;
          box-shadow: inset 1em 0 2em -1em #00fff066,
        ...
        .bell-btm2 {
          ...
          translate: 0 24em;
          background: #00fff0;
          box-shadow: 0 0 1em 0.6em #00fff0, -0.8em 0.2em 2em 1em #0d9d9e,
              -5.4em -0.6em 3em -1em #0891b2bb, 6em -0.6em 3em -1em #0891b2bb,
              inset 0em 30.3em 0.3em -30em #06b6d4, inset 0 -2em 2em -2em #00fff0,
              inset 0em -1em 2em 1em #0891b266;
          filter: brightness(1);
        }
        .off .bell-btm2 {
        ...
        .bell-ring {
          ...
          border-radius: 50%;
          translate: 0 -6em;
          box-shadow: 0 0.8em 1em -0.3em #a5f3fc,
            inset 0 -6em 4em -4em #22d3ee, inset 0 1em 3em 1em #fff4,
            inset 0 2em 3em 1em #fff, inset 0 100em 0 100em #0c4a6e;
        }
        .off .bell-ring {
          background: #000;
          box-shadow: 0 0.8em 1em -0.3em #0000,
            inset 0 -6em 4em -4em #22d3ee00, inset 0 1em 3em 1em #fff0,
        ...
        .volumetric .vl {
          ...
          rotate: 22deg;
          box-shadow: inset 40em 0 20em -20em #00fff011;
        }
        .volumetric .vr {
          width: 100%;
          height: 100%;
        ...
        .button:focus-visible {
          color: #fff;
          text-shadow: 0 -1px 3px #fff, 0 0 20px #00fff0;
          outline: none;
        }
        .button::before,
        .button::after {
        ...
        @keyframes lumenbtn {
          0% {
            box-shadow: inset 0 0.04em 0.06em 0 #fff,
              ...
              inset calc(-0.2em * var(--degofrot)) 0.2em 0.4em 0 #00fff0;
          }
          50% {
            box-shadow: inset 0 0.04em 0.06em 0 #fff,
              inset calc(0.2em * var(--degofrot)) 1em 1em 0 #fff5,
